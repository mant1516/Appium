package org.housejoy.pom.homecleaning;
...
public class HomeCleaningThankUPage extends BasePage {


	public HomeCleaningThankUPage(WebDriver driver) {
		super(driver);
	}
	...
	public void validateLeadMasterTableValues(String cookieID, String serviceType, String cityName, String leadStatus, String emailID, String mobileNumber, String userName) throws Exception {
		...
		Assert.assertEquals(true,userName.equalsIgnoreCase(retrievedDBValues.get(6)));
	}
}
