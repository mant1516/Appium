...
public class VerifyPlumbingDetails extends BasePage {


	public VerifyPlumbingDetails(WebDriver driver) {
		super(driver);
	}
	...
	// moved this method to Basepage since it is a common method used in all SEM pages
