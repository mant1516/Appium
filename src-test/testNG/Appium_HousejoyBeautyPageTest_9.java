...
public class Appium_HousejoyBeautyPageTest_9 {
	 ...
	 */
		...
		public void setUp() throws MalformedURLException{
			...
			capabilities.setCapability("deviceName", "Lenovo A319");
			...
			capabilities.setCapability("appPackage", "com.android.chrome"); //For Chrome Browser
			capabilities.setCapability("appActivity", "com.google.android.apps.chrome.document.ChromeLauncherActivity"); //For Chrome Browser
