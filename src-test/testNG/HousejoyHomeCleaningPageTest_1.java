 ...
 * 
 */
public class HousejoyHomeCleaningPageTest_1 {
	
	public WebDriver driver;
	HomeCleaningLandingPage_1 HomeCleaningLeadPage;
	...
	public void setup() {
		...
		HomeCleaningLeadPage = PageFactory.initElements(driver, HomeCleaningLandingPage_1.class);
	 ...
	 */  
	@Test(groups = { "p1" }, dataProviderClass = HousejoyHomeCleaningPageData.class, dataProvider = "HomeCleaningLandingValues_1", priority = 1)
	public void testHousejoyHomeCleaningLandingPage(Map<String,String> landingPageValues) throws Throwable {
		try {
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("QaSemPages")) {
				HomeCleaningLeadPage.loadPage(landingPageValues.get("QA_Url"));
			}
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("ProductionSemPages")) {
				HomeCleaningLeadPage.loadPage(landingPageValues.get("Prod_Url"));
			}
			...
			HomeCleaningLeadPage.click_BookNowBtn();
		} catch (Throwable t) {
	...
	public void testHousejoyHomeCleaningBookPage(Map<String,String> LeadBookingPageValues) throws Throwable {
		try {
			...
			HomeCleaningLeadBookPage.validateThankUHeader(LeadBookingPageValues.get("verifyPage"));
			HomeCleaningLeadBookPage.selectSubServiceButton();
			HomeCleaningLeadBookPage.selectDateFromDatePicker();
