 ...
 * 
 */
public class HousejoyBeautyPageTest_13 {
	
	public WebDriver driver;
	BeautyLandingPage_1 BeautyLeadPage;
	...
	public void setup() {
		...
		BeautyLeadPage = PageFactory.initElements(driver, BeautyLandingPage_1.class);
	 ...
	 */  
	@Test(groups = { "p1" }, dataProviderClass = HousejoyBeautyPageData.class, dataProvider = "BeautyLandingPageValues_13", priority = 1)
