 ...
 * 
 */
public class HousejoyBeautyPageTest_10 {
	 ...
	 */  
	@Test(groups = { "p1" }, dataProviderClass = HousejoyBeautyPageData.class, dataProvider = "BeautyLandingPageValues_10", priority = 1)
