 ...
 * 
 */
public class HousejoyServiceLaptopRepairPageTest {
	...
	public void testComputerRepairLandingPage(Map<String,String> landingPageValues) throws Throwable {
		try {
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("QaSemPages")) {
				ServiceLappyRepairLandingPage.loadPage(landingPageValues.get("QA_Url"));
			}
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("ProductionSemPages")) {
				ServiceLappyRepairLandingPage.loadPage(landingPageValues.get("Prod_Url"));
			}
			...
			ServiceLappyRepairLandingPage.click_BookComputerRepair();
