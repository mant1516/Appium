...
import org.housejoy.pom.beauty.BeautyLandingPage;
 ...
 * 
 */
public class HousejoyBeautyPageTest {
	
	public WebDriver driver;
	BeautyLandingPage BeautyLeadPage;
	...
	public void setup() {
		...
		BeautyLeadPage = PageFactory.initElements(driver, BeautyLandingPage.class);
	 ...
	 */  
	@Test(groups = { "p1" }, dataProviderClass = HousejoyBeautyPageData.class, dataProvider = "BeautyLandingPageValues", priority = 1)
	public void testHousejoyBeautyLandingPage(Map<String,String> landingPageValues) throws Throwable {
		try {
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("QaSemPages")) {
				BeautyLeadPage.loadPage(landingPageValues.get("QA_Url"));
			}
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("ProductionSemPages")) {
				BeautyLeadPage.loadPage(landingPageValues.get("Prod_Url"));
			}
			...
			BeautyLeadPage.setText_CustomerEmail(landingPageValues.get("custEmail"));
	 ...
	 */
	@Test(groups = {"p1" }, priority = 3, dependsOnMethods = "testHousejoyBeautyLandingPage", dataProviderClass = HousejoyBeautyPageData.class, dataProvider = "BeautyLeadBookingPage")
	public void testHousejoyBeautyBookPage(Map<String,String> LeadBookingPageValues) throws Throwable {
		try {
			...
			BeautyLeadBookPage.selectSubServiceButton();
			BeautyLeadBookPage.selectDateFromDatePicker();
	 ...
	 */
	@Test(groups = { "p1" }, priority = 4, dependsOnMethods = "testHousejoyBeautyBookPage", dataProviderClass = HousejoyBeautyPageData.class, dataProvider = "leadTableValues")
