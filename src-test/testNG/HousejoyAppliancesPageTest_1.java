 ...
 * 
 */
public class HousejoyAppliancesPageTest_1 {

	public WebDriver driver;
	AppliancesLandingPage_1 ApplianceLandingPage;
	...
	public void setup() {
		...
		ApplianceLandingPage = PageFactory.initElements(driver, AppliancesLandingPage_1.class);
	 ...
	 */
	@Test(groups = { "p1" }, priority = 1, dataProviderClass = HousejoyAppliancesPageData.class, dataProvider = "ApplianceLandingValues_1")
	public void testApplianceLandingPage(Map<String,String> landingPageValues) throws Throwable {
		try {
			...
			ApplianceLandingPage.click_ApplianceSubmit();
