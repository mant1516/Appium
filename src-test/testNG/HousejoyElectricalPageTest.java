 ...
 * 
 */
public class HousejoyElectricalPageTest {
	...
	public void testHousejoyElectricalLandingPage(Map<String,String> landingPageValues) throws Throwable {
		try {
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("QaSemPages")) {
				ElectricalLeadPage.loadPage(landingPageValues.get("QA_Url"));
			}
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("ProductionSemPages")) {
				ElectricalLeadPage.loadPage(landingPageValues.get("Prod_Url"));
			}
			...
			ElectricalLeadPage.click_BookNowBtn();
		} catch (Throwable t) {
	...
	public void testHousejoyElectricalBookPage(Map<String,String> LeadBookingPageValues) throws Throwable {
		try {
			...
			ElectricalLeadBookPage.validateThankUHeader(LeadBookingPageValues.get("verifyPage"));
			ElectricalLeadBookPage.selectSubServiceButton();
			ElectricalLeadBookPage.selectDateFromDatePicker();
