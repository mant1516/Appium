...
import org.housejoy.pom.appliances.AppliancesLandingPage;
import org.housejoy.pom.appliances.AppliancesLandingPage_1;
import org.housejoy.pom.appliances.AppliancesLandingPage_2;
 ...
 * 
 */
public class HousejoyAppliancesPageTest_2 {

	public WebDriver driver;
	AppliancesLandingPage_2 ApplianceLandingPage;
	...
	public void setup() {
		...
		ApplianceLandingPage = PageFactory.initElements(driver, AppliancesLandingPage_2.class);
	...
	/**
	 * @Desc Test method is used for testing the landing page of ApplianceLandingPages.
	 */
	@Test(groups = { "p1" }, priority = 1, dataProviderClass = HousejoyAppliancesPageData.class, dataProvider = "ApplianceLandingValues_2")
	public void testApplianceLandingPage(Map<String,String> landingPageValues) throws Throwable {
		try {
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("QaSemPages")) {
				ApplianceLandingPage.loadPage(landingPageValues.get("QA_Url"));
			}
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("ProductionSemPages")) {
				ApplianceLandingPage.loadPage(landingPageValues.get("Prod_Url"));
			}
			...
			ApplianceLandingPage.click_BookTechnicianNowBtn();
	...
	public void testApplianceBookingPage(Map<String,String> LeadBookingPageValues) throws Throwable {
		try {
			...
			ApplianceLeadBookPage.validateThankUHeader(LeadBookingPageValues.get("verifyPage"));
			ApplianceLeadBookPage.selectSubServiceButton();
			ApplianceLeadBookPage.selectDateFromDatePicker();
			...
			ApplianceLeadBookPage.setText_EmailId(LeadBookingPageValues.get("custEmail"));
	 ...
	 */
	@Test(groups = { "p1" }, priority = 4, dependsOnMethods = "testApplianceBookingPage", dataProviderClass = HousejoyAppliancesPageData.class, dataProvider = "leadTableValues_2")
