 ...
 * 
 */
public class HousejoyAppliancesPageTest {

	public WebDriver driver;
	AppliancesLandingPage ApplianceLandingPage;
	...
	public void setup() {
		...
		ApplianceLandingPage = PageFactory.initElements(driver, AppliancesLandingPage.class);
	 ...
	 */
	@Test(groups = { "p1" }, priority = 1, dataProviderClass = HousejoyAppliancesPageData.class, dataProvider = "ApplianceLandingValues")
	 ...
	 */
	@Test(groups = { "p1" }, priority = 4, dependsOnMethods = "testApplianceBookingPage", dataProviderClass = HousejoyAppliancesPageData.class, dataProvider = "leadTableValues")
