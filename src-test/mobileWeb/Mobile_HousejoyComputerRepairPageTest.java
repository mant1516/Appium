...
import org.housejoy.pom.computerrepair.ComputerRepairLandingPage_laptopRepair_1;
 ...
 * 
 */
public class Mobile_HousejoyComputerRepairPageTest {

	public WebDriver driver;
	BasePage MainPage;
	ComputerRepairLandingPage CompRepairLandingPage;
	...
	public void setup() throws FileNotFoundException, IOException {
		try {
			...
			CompRepairLandingPage = PageFactory.initElements(driver, ComputerRepairLandingPage.class);
	 ...
	 */
	@Test(groups = { "p1" }, priority = 1, dataProviderClass = HousejoyComputerRepairData.class, dataProvider = "ComputerRepairLandingValues")
	public void testComputerRepairLandingPage(Map<String,String> landingPageValues) throws Throwable {
		try {
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("QaSemPages")) {
				CompRepairLandingPage.loadMobilePage(landingPageValues.get("QA_Url"));
			}
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("ProductionSemPages")) {
				CompRepairLandingPage.loadMobilePage(landingPageValues.get("Prod_Url"));
			}
			...
			CompRepairLandingPage.click_SubmitBtnMobile();
	 ...
	 */
	@Test(groups = { "p1" }, priority = 4, dependsOnMethods = "testComputerRepairBookingPage", dataProviderClass = HousejoyComputerRepairData.class, dataProvider = "leadTableValues")
