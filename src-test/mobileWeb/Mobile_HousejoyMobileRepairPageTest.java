 ...
 * 
 */
public class Mobile_HousejoyMobileRepairPageTest {
	...
	public void testMobileRepairBookingPage(Map<String,String> LeadBookingPageValues) throws Throwable {
		try {
			...
			//MobRepairLeadPage.validateThankUHeader(LeadBookingPageValues.get("verifyMobilePage"));
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("QaSemPages")) {
			...
			MobRepairLeadPage.setText_SpecialInstructionsMobile(LeadBookingPageValues.get("specialInstruction"));			
			...
			MobRepairLeadPage.click_ConfirmBookingBtnMobile();
