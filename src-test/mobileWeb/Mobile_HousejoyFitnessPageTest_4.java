...
import org.housejoy.pom.fitness.FitnessLandingPage_4;
 ...
 * 
 */
public class Mobile_HousejoyFitnessPageTest_4 {
	
	public WebDriver driver;
	FitnessLandingPage_4 FitnessLeadPage;
	...
	public void setup() throws FileNotFoundException, IOException {
		try {
			...
			FitnessLeadPage = PageFactory.initElements(driver, FitnessLandingPage_4.class);
	 ...
	 */  
	@Test(groups = { "p1" }, dataProviderClass = HousejoyFitnessPageData.class, dataProvider = "FitnessLandingPageValues_4", priority = 1)
	...
	public void testHousejoyFitnessBookPage(Map<String,String> LeadBookingPageValues) throws Throwable {
		try {
			//FitnessLeadBookPage.validateThankUHeader(LeadBookingPageValues.get("verifyPage_4"));
			...
			FitnessLeadBookPage.setText_EmailId(LeadBookingPageValues.get("custEmail"));
			...
			FitnessLeadBookPage.click_BookNowBtn_4();
		} catch (Throwable t) {
	 ...
	 */
	@Test(groups = { "p1" }, priority = 4, dependsOnMethods = "testHousejoyFitnessBookPage", dataProviderClass = HousejoyFitnessPageData.class, dataProvider = "leadTableValues_4")
