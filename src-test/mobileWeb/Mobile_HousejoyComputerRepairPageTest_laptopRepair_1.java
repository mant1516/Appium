 ...
 * 
 */
public class Mobile_HousejoyComputerRepairPageTest_laptopRepair_1 {

	public WebDriver driver;
	BasePage MainPage;
	ComputerRepairLandingPage_laptopRepair_1 CompRepairLandingPage;
	...
	public void setup() throws FileNotFoundException, IOException {
		try {
			...
			CompRepairLandingPage = PageFactory.initElements(driver, ComputerRepairLandingPage_laptopRepair_1.class);
	 ...
	 */
	@Test(groups = { "p1" }, priority = 1, dataProviderClass = HousejoyComputerRepairData.class, dataProvider = "ComputerRepairLandingValues_laptopRepair_1")
