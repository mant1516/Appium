 ...
 * 
 */
public class Mobile_HousejoyCarpentryPageTest {
	...
	public void testHousejoyCarpentryLandingPage(Map<String,String> landingPageValues) throws Throwable {
		try {
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("QaSemPages")) {
				CarpentryLeadPage.loadMobilePage(landingPageValues.get("QA_Url"));
			}
			if (CommonTools.getProperty("SEMSuiteName").contentEquals("ProductionSemPages")) {
				CarpentryLeadPage.loadMobilePage(landingPageValues.get("Prod_Url"));
			}
			...
			CarpentryLeadPage.click_SubmitBtnMobile();
		} catch (Throwable t) {
	...
	public void testHousejoyCarpentryBookPage(Map<String,String> LeadBookingPageValues) throws Throwable {
		try {
			...
			CarpentryLeadBookPage.selectSubServiceButtonForMobile();
			CarpentryLeadBookPage.selectDateFromDatePickerForMobile();
